...
public class Salter 
{
    ...
    {
        private final Map<byte[], Put> putMap = new TreeMap<byte[], Put>(Bytes.BYTES_COMPARATOR);
        ...
        public List<Put> take()
        {
            try
            {
                return new ArrayList<Put>(putMap.values());
            }
            finally
            {
                putMap.clear();
    ...
    {
        private final Map<byte[], List<KeyValue>> familyMap = new TreeMap<byte[], List<KeyValue>>(Bytes.BYTES_RAWCOMPARATOR);
        private final Map<byte[], Long> familySize = new TreeMap<byte[], Long>(Bytes.BYTES_RAWCOMPARATOR);
        private final Set<byte[]> familiesOverHeap = new TreeSet<byte[]>(Bytes.BYTES_RAWCOMPARATOR);
        ...
        private List<KeyValue> getKeyValueList(byte[] family)
        {
            ...
            {	
                keyValueList = new LinkedList<KeyValue>();
        ...
        public List<List<KeyValue>> take()
        {
            try
            {
                List<List<KeyValue>> keyValueSetList = new LinkedList<List<KeyValue>>();
        ...
        {
            return new HashSet<byte[]>(familiesOverHeap);
        }
